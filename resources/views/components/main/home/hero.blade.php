<section class="container mx-auto my-24 flex flex-wrap items-center justify-between px-5">
  <div class="w-full md:w-1/2 md:pr-10">
    ...
    <p class="musicArtistFont font-bold">
    ...
    <p class="font-light" style="color: #505778">
      ...
      asset stocks in any Upcoming, Independent & Major Artist brand & receive a portion of their revenue
      as
    ...
    <div class="mt-4 flex w-fit flex-row items-center justify-center lg:justify-start">
      ...
      <div class="ellipse">
        <div class="playArrow">
          <svg data-testid="PlayArrowIcon" aria-hidden="true" fill="#ff0093" width="25px" height="25px" focusable="false" viewBox="0 0 24 24">
